  ...
  return (
    <div className="flex flex-1 min-h-0">
      ...
      >
        ...
        <div
          className="flex flex-col gap-1 overflow-y-auto flex-1 min-h-0"
            ...
            <div className="flex-none" style={{ borderTop: "1px solid var(--color-neutral-200)", position: "relative" }}>
              ...
              <form ref={composerFormRef} onSubmit={handleSend} className="flex items-end gap-2 p-3">
                ...
                <input
                  ...
                  // which doesn't just prioritize those types in the OS
                  // picker — it hides everything else (a .docx couldn't even
                  // be selected). The message bubble already renders any
                  // attachment generically (📄 filename) when it isn't an
                  // image, so there's nothing type-specific left to fix.
                  multiple
                  className="hidden"
                  onChange={(e) => {
