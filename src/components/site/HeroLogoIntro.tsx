...
// within that shared frame, so stacking them with `fill` lines everything
// up with no per-layer offsets to hand-tune. Keyframes live in
// globals.css (fk-logo-intro-*) since this plays once on mount, not on
// scroll — no need for the Reveal component's IntersectionObserver.
